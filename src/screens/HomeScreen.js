...
export default class HomeScreen extends React.Component {
   ...
   //    fetch('https://www.food2fork.com/api/search?key=f10ee4f202d8b33072da1344ae080344')
   ...
   //             //data: resposeJson;
   //             data: resposeJson.recipes,
   //             loading: false

   //          })

   //          this.arrayholder= resposeJson.recipes;

   //       })

   //       // .catch ((error)=> console.log('Error',error));
   //       .catch((error) => console.log({ loading: false }));
   // }
   ...
   renderItem = ({ item }) => {
      ...
      return (
         ...
         //<Text>{item.publisher}</Text>
         <RecipeItem navigation={this.props.navigation} item={item} />
